...
class Inicon(object):
	...
	def inicon(self):
		# this function will make the file run in the background
		# but also have an ico
		...
		data = 'pyinstaller -w -i "' + str(self.icon) + '" --distpath "' + str(head) + '/dist' + '" --workpath "' + str(head) + '" --specpath "' + str(head) + '" "' + str(self.filename) + '"'
